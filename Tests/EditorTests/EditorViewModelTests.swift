...
class EditorViewModelTests: XCTestCase {
    ...
    func testColumnPreservationFromLastCharacterOfLine() {
        ...
        XCTAssertEqual(
            editor.cursorPosition, 13, "Cursor should be on the last character of the shorter line."
        )
        ...
        XCTAssertEqual(
            editor.cursorPosition, 19, "Cursor should be on the last character of the shorter line."
        )
    }
    ...
    func testRepeatDeleteWord() {
        ...
        // Perform "dw"
        editor.commandSM.handleToken(.delete, editor: editor)
        editor.commandSM.handleToken(.wordForward, editor: editor)
        ...
        editor.commandSM.handleToken(.repeatLastAction, editor: editor)
